...
//@interface PlatinotemplateObject : NSObject
//@end

@interface PlatinotemplateObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[PlatinotemplateObject class]])
		{
			for (NSString *key in [[(PlatinotemplateObject*)o modules] allKeys])
			{
