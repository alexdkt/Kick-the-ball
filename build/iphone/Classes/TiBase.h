...
// in simulator we redefine to format for Platinotemplate Developer console
...
{\
	NSString * exceptionName = [@"org.platinotemplate." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.platinotemplate";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPlatinotemplateNativeItemNone = -1, 
	UIPlatinotemplateNativeItemSpinner = -2,
	UIPlatinotemplateNativeItemProgressBar = -3,
	
	UIPlatinotemplateNativeItemSlider = -4,
	UIPlatinotemplateNativeItemSwitch = -5,
	UIPlatinotemplateNativeItemMultiButton = -6,
	UIPlatinotemplateNativeItemSegmented = -7,
	
	UIPlatinotemplateNativeItemTextView = -8,
	UIPlatinotemplateNativeItemTextField = -9,
	UIPlatinotemplateNativeItemSearchBar = -10,
	
	UIPlatinotemplateNativeItemPicker = -11,
	UIPlatinotemplateNativeItemDatePicker = -12,
	
	UIPlatinotemplateNativeItemInfoLight = -13,
	UIPlatinotemplateNativeItemInfoDark = -14,
	
	UIPlatinotemplateNativeItemDisclosure = -15,
	
	UIPlatinotemplateNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Platinotemplate instances of
