...
/**
 Base class for all Platinotemplate views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Platinotemplate view hierarchy (such as wrapped iOS UIViews) was touched.
