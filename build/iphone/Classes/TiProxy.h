...
//Rare exceptions to indicate a bug in the _platinotemplate code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Platinotemplate proxies.
 */
