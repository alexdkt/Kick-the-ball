...
@interface PlatinotemplateObject : KrollCoverageObject {
#else
@interface PlatinotemplateObject : KrollObject {
#endif
@private
...
extern NSString * Platinotemplate$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	PlatinotemplateObject *_platinotemplate;
    KrollObject* console;
	BOOL shutdown;
